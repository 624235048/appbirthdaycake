    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Container(
              child: Image.asset("assets/images/เลขบัญชี.png"),
            ),
            Padding(
              padding: const EdgeInsets.all(10),
              child: ElevatedButton(
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.all<Color>(Colors.pink.shade100), // เปลี่ยนสีพื้นหลังเป็นสีแดง
                  foregroundColor: MaterialStateProperty.all<Color>(Colors.white),
                  padding: MaterialStateProperty.all<EdgeInsets>(EdgeInsets.symmetric(horizontal: 16, vertical: 8)),// เปลี่ยนสีตัวอักษรเป็นสีขาว
                ),
                onPressed: () => _pickImage(ImageSource.gallery),
                //style: ElevatedButton.styleFrom(primary: Colors.pinkAccent.shade50),
                child: Row(
                  children: [Icon(Icons.image_outlined), Text('PICK FROM GALLERY')],
                ),
              ),
            ),
            SizedBox(
            ...
            file == null ? Container(width:300,height: 300,child: Image.asset('assets/images/galary.png')) : Image.file(file),
          ],
        ),
      ),
    );
