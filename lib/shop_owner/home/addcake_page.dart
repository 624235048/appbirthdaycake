  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('AddCake', style: TextStyle(
            color: Colors.white),),
      ),
      body: Form(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    inputFormatters: [
                      FilteringTextInputFormatter.allow(RegExp('[ก-๙เแโใไ่ิึี้ื่้๊๋์ฺุู฿]')), // อนุญาตให้ป้อนตัวอักษรภาษาไทย
                    ],
                    decoration: InputDecoration(
                      labelText: 'CakeName',
                      hintText: 'Enter CakeName',
                      border: OutlineInputBorder(),
                      labelStyle: TextStyle(color: Colors.pink.shade100),  // กำหนดสีให้กับตัวอักษร Label
                      hintStyle: TextStyle(color: Colors.pink.shade100),   // กำหนดสีให้กับตัวอักษร Hint
                    ),
                    validator: (value) {
                      if (value.isEmpty) {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        final isValidFrom = formKey.currentState.validate();
                         if (isValidFrom) {
                             if (file != null || pricecontroller.toString().isEmpty) {
                              uplodeimageandsave();
  ...
  Future<Null> uplodeimageandsave() async {
    ...
    try {
      ...
      await Dio().post(url, data: formData).then((value) async {
        ...
        String urlInsert = '${API.BASE_URL}/flutterapi/src/addCake.php?isAdd=true&cn_cakename=$cakename&cn_desc=$details&cn_price=$cn_price&cn_images=$cn_images&size_id=size_id';
